      ...
      <div className="animate-fade-in" style={{ fontFamily: '"Inter", sans-serif', background: '#f8fafc' }}>
        ...
        <div id="What-is-LTC" style={{ padding: '100px 20px', background: '#f8fafc' }}>
          <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
            <div className="responsive-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '60px', alignItems: 'center' }}>
              <div>
                <span style={{ fontSize: '12px', fontWeight: '800', color: '#f59e0b', textTransform: 'uppercase', letterSpacing: '2px' }}>Overview</span>
                <h2 style={{ fontSize: '36px', fontWeight: '800', color: '#0f172a', margin: '10px 0 20px' }}>What is LTC?</h2>
                <div style={{ width: '40px', height: '3px', background: '#f59e0b', marginBottom: '30px' }}></div>
        ...
        <div id="Why-LTC" style={{ padding: '100px 20px', background: '#0a0f1d', color: 'white' }}>
          <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
            <div style={{ textAlign: 'center', marginBottom: '60px' }}>
              <span style={{ fontSize: '12px', fontWeight: '800', color: '#f59e0b', textTransform: 'uppercase', letterSpacing: '2px' }}>Purpose</span>
            ...
            <div className="responsive-grid" style={{ display: 'grid', gridTemplateColumns: '1.5fr 2.5fr', gap: '40px' }}>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
                {whyLtcData.map(item => (
                  <div 
                    ...
                    style={{ 
                      background: activeCard === item.id ? '#ea580c' : 'rgba(255,255,255,0.05)',
              ...
              <div style={{ background: 'rgba(255,255,255,0.03)', borderRadius: '24px', padding: '40px', border: '1px solid rgba(255,255,255,0.05)', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                <h3 style={{ fontSize: '24px', fontWeight: '800', color: '#f59e0b', marginBottom: '20px' }}>{whyLtcData.find(i => i.id === activeCard)?.title}</h3>
        ...
        <div id="Root-at-MIT-WPU" style={{ padding: '100px 20px', background: 'white' }}>
          <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
            <div className="responsive-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '60px', alignItems: 'center' }}>
              ...
              <div>
                <span style={{ fontSize: '12px', fontWeight: '800', color: '#f59e0b', textTransform: 'uppercase', letterSpacing: '2px' }}>Legacy</span>
        ...
        <div id="Philosophy-Soil-to-Soul" style={{ padding: '100px 20px', background: '#f8fafc' }}>
          <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
            <div className="responsive-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '60px', alignItems: 'center' }}>
              <div>
                <span style={{ fontSize: '12px', fontWeight: '800', color: '#f59e0b', textTransform: 'uppercase', letterSpacing: '2px' }}>Mantra</span>
        ...
        <div id="The-Sacred-Yajna" style={{ padding: '100px 20px', background: 'white' }}>
          <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
            <div className="responsive-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '60px', alignItems: 'center' }}>
              ...
              <div>
                <span style={{ fontSize: '12px', fontWeight: '800', color: '#f59e0b', textTransform: 'uppercase', letterSpacing: '2px' }}>Tradition</span>
        ...
        <div id="Anubhavamrta-Sevita" style={{ padding: '100px 20px', background: '#f8fafc' }}>
          <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
            <div className="responsive-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '60px', alignItems: 'center' }}>
              <div>
                <span style={{ fontSize: '12px', fontWeight: '800', color: '#f59e0b', textTransform: 'uppercase', letterSpacing: '2px' }}>Experience</span>
        ...
        <div id="Rooted-in-Bharat" style={{ padding: '100px 20px', background: 'white' }}>
          <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
            <div className="responsive-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '60px', alignItems: 'center' }}>
              ...
              <div>
                <span style={{ fontSize: '12px', fontWeight: '800', color: '#f59e0b', textTransform: 'uppercase', letterSpacing: '2px' }}>Identity</span>
        ...
        <div id="The-Birth-of-Movement" style={{ padding: '80px 20px', background: 'linear-gradient(135deg, #1e3a8a 0%, #1e1b4b 100%)', color: 'white', textAlign: 'center' }}>
          <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            <span style={{ fontSize: '12px', fontWeight: '800', color: '#f59e0b', textTransform: 'uppercase', letterSpacing: '2px' }}>Origin</span>
        ...
        <div id="Logo-Design-Journey" style={{ padding: '100px 20px', background: 'white' }}>
          <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
            <div style={{ textAlign: 'center', marginBottom: '60px' }}>
              <span style={{ fontSize: '12px', fontWeight: '800', color: '#f59e0b', textTransform: 'uppercase', letterSpacing: '2px' }}>Symbolism</span>
        ...
        <div id="NEP-2020" style={{ padding: '100px 20px', background: '#f8fafc' }}>
          <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
            <div style={{ textAlign: 'center', marginBottom: '60px' }}>
              <span style={{ fontSize: '12px', fontWeight: '800', color: '#f59e0b', textTransform: 'uppercase', letterSpacing: '2px' }}>Alignment</span>
